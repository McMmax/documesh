import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, defineAsyncComponent, onScopeDispose, watch, computed, toValue, unref, defineComponent, useSlots, h, Fragment, createElementBlock, provide, cloneVNode, withCtx, createVNode, useSSRContext, mergeProps, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "C:/Users/trapaholics/WebstormProjects/documint/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/trapaholics/WebstormProjects/documint/node_modules/nuxt/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/trapaholics/WebstormProjects/documint/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "C:/Users/trapaholics/WebstormProjects/documint/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { START_LOCATION, createMemoryHistory, createRouter } from "vue-router";
import defu$1, { defu, defuFn } from "C:/Users/trapaholics/WebstormProjects/documint/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol } from "C:/Users/trapaholics/WebstormProjects/documint/node_modules/ufo/dist/index.mjs";
import { useHead as useHead$1, headSymbol } from "C:/Users/trapaholics/WebstormProjects/documint/node_modules/@unhead/vue/dist/index.mjs";
import { klona } from "C:/Users/trapaholics/WebstormProjects/documint/node_modules/klona/dist/index.mjs";
...
import { t, schema, table, reducers as reducers$2, reducerSchema, procedures, makeQueryBuilder, convertToAccessorMap, DbConnectionImpl, DbConnectionBuilder as DbConnectionBuilder$1, SubscriptionBuilderImpl } from "spacetimedb";
if (!globalThis.$fetch) {
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/_id_-Bawvu206.js")
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/dashboard-CJch8MmR.js")
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/index-Dn1YvUiR.js")
  }
];
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/index-BZauEo50.js").then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CKyxZPEv.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-B_TahtG9.js"));
