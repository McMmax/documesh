import {
  ...
  unexpectedCase
} from "./chunk-2SHHY4RV.js";
import {
  Decoration,
  DecorationSet
} from "./chunk-KVUML5BZ.js";
import {
  AllSelection,
  NodeSelection,
  Plugin,
...
var getRelativeSelection = (pmbinding, state) => {
  ...
  return {
    ...
    depth: type === "nodeRange" ? (
      /** @type {any} */
      state.selection.depth
    ) : void 0,
...
var MetaEntriesQueue = class _MetaEntriesQueue {
  /**
  ...
  static fromViewsToUpdate() {
    ...
    return new _MetaEntriesQueue(entries);
  }
};
...
//# sourceMappingURL=chunk-E4HZ22KV.js.map
