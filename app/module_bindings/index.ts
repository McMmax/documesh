...
import AwarenessStateRow from "./awareness_state_table";
import DocumentRow from "./document_table";
import YjsUpdateRow from "./yjs_update_table";

/** Type-only namespace exports for generated type groups. */

/** The schema information for all tables in this module. This is defined the same was as the tables would have been defined in the server. */
const tablesSchema = __schema({
  awareness_state: __table({
    name: 'awareness_state',
    indexes: [
      { accessor: 'user_id', name: 'awareness_state_user_id_idx_btree', algorithm: 'btree', columns: [
        'userId',
      ] },
    ],
    constraints: [
      { name: 'awareness_state_user_id_key', constraint: 'unique', columns: ['userId'] },
    ],
  }, AwarenessStateRow),
  document: __table({
    name: 'document',
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("document_create", DocumentCreateReducer),
  __reducerSchema("document_update_title", DocumentUpdateTitleReducer),
  __reducerSchema("update_awareness", UpdateAwarenessReducer),
);
