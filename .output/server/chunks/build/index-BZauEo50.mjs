import { defineComponent, computed, h, onServerPrefetch, isRef, toValue, getCurrentInstance, ref, shallowRef, nextTick, unref, toRef } from 'vue';
import { Icon, getIcon, loadIcon as loadIcon$1 } from '@iconify/vue';
import { getIconCSS } from '@iconify/utils/lib/css/icon';
import { C as hash } from '../_/nitro.mjs';
import { d as useNuxtApp, h as useAppConfig, f as useRuntimeConfig, u as useHead, i as asyncDataDefaults, j as createError } from './server.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
//# sourceMappingURL=index-BZauEo50.mjs.map
